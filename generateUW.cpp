...
int main()
{
    ...
    ifstream finit;
    finit.open("yelp_training_set/user_to_word.txt");
    ...
    // Obtain top 1k user 
    cout<<"Obtaining 1k user list..."<<endl;
    ...
    cout<<"Outputing the 1k user list..."<<endl;
    ofstream fout1000;    
    fout1000.open("user_conversion_list.txt");
    int bus_count = 1; 
    ...
    cout<<"Generating the User-Word matrix..."<<endl;

    ifstream fin;
    fin.open("yelp_training_set/user_to_word.txt");
    ofstream fout;
    fout.open("user_word_matrix.txt");
    ...
    ofstream fmat;
    fmat.open("official_user_word_matrix.txt");
